    ...
    <div class="nav-info mb-5">
        <div class="container">
            <div class="row">
                ...
                <!--aside-->
                <div class="col-md-4">
                    @include('Frontend.Product.Sub-Category-Wise.Partials.sort-by')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 product-filter">
                    @include('Frontend.Product.Sub-Category-Wise.Partials.browse-by-price')
                    @include('Frontend.Product.Sub-Category-Wise.Partials.browse-by-category')
                </div>
                <!--aside-->
                                                    ...
                                                    <h5>
                                                        <b>
                                                            @if($flash && $forYou->discount_amount > 0)
                                                                ...
                                                                <span style="color: #f30404;">{{ $forYou->discount_amount }}
