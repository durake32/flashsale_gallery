                                            ...
                                            <tr role="row" class="odd">
                                                <td>
                                                    <div class="img-container">
                                                        <img src="{{ asset('Asset/Uploads/advertisements1/'.$advertisement->url) }}"
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a href="{{ route('admin.advertisement1.edit',$advertisement->id) }}"
                                                    ...
                                                    <a class="btn btn-link btn-danger btn-just-icon remove">
                                                        <form
                                                            ...
                                                            action="{{route('admin.advertisement1.destroy',$advertisement->id)}}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit">
